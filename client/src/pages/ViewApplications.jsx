...
function ViewApplications() {
  ...
  //function t fetch company job appication data
  ...
  //Function To update Job Application staus
  const changeJobAplicationStaus = async (id, status) => {
    try {
                  ...
                  <tr key={index} className="text-gray-700">
                    ...
                    <td className="py-2 px-4 border-b relative ">
                      {applicant.status === "Pending" ? (
                        <div
                          className="
                    relative inline-block text-left group"
                        >
